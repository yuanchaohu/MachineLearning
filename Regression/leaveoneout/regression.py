...
#-----train & test--------
condition = (data['group'] == 3) & (data['fB'] == 0.5)
x_train = data.loc[~condition, features]
y_train = data.loc[~condition, 'logRc']
x_test = data.loc[condition, features]
y_test = data.loc[condition, 'logRc']
