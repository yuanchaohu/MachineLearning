...
conditions = (data2['components'] <= 2)
data2['method'] = np.nan
data2['method'][conditions]  = 'meltspin'
data2['method'][~conditions] = 'bulk'
print ('Hu data: ', data2.shape, file = fileoutput)

#------------read third database-------------------
data3 = pd.read_csv('./LoganMG/useddata/combined.csv')
#data3['XRDname'] = 'Logan'
data3['method'] = data3['XRDname'].copy()
...
print (data['method'].value_counts() / data.shape[0], file = fileoutput)
