...
#------get the composition of each XRD pattern--------------
    ...
    print ('Folder: ', i)
    print ('Folder index:', homedirall.index(i))
...
#------analyze the XRD patterns-----------------------------
    ...
    if input('Do you want to continue? Press [y] or [n]: ') == 'n':
        break
    else:
        print ('-----relax 5 seconds THEN move to the next folder------')
        print (' ')
        time.sleep(5)
